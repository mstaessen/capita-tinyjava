...
predicate_family thread_run_pre(void *thread_run)(void *data, void* info);
predicate_family thread_run_post(void *thread_run)(void *data, void* info);
...
/*@
predicate thread(struct thread *thread, void *thread_run, void *data, void* info);
@*/
...
struct thread *thread_start_joinable(void *run, void *data);
    ...
    //@ ensures result != 0 &*& thread(result, run, data, info);
